            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  ...
                  defaultValue="Experienced freelance architect with 5+ years of expertise in residential and commercial design."
                  rows={4}
                />
              </div>
              <div className="space-y-2">
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Automatically start timer when opening a project
                  </p>
                </div>
                <Switch />
              </div>
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Get reminded to track time if inactive
                  </p>
                </div>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Get notified when assigned to new projects
                  </p>
                </div>
                <Switch defaultChecked />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label>Project Messages</Label>
                  <p className="text-sm text-muted-foreground">
                    Get notified of new project messages
                  </p>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label>Time Log Approvals</Label>
                  <p className="text-sm text-muted-foreground">
                    Notifications when time logs are approved
                  </p>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Receive weekly activity summaries via email
                  </p>
                </div>
                <Switch />
              </div>
