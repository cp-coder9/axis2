...
export const generateTimeTrackingReport = async (
    ...
    try {
        ...
        // All logs are considered billable unless explicitly marked otherwise
        const totalBillableMinutes = totalMinutes;
        ...
        return {
            ...
            projectBreakdown: [{
                projectId,
                projectTitle: '', // Would need to fetch from project data
                hours: totalHours,
